...
export class IngredientUserRelationsUpdate1607100478654
  implements MigrationInterface {
  name = 'IngredientUserRelationsUpdate1607100478654';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "ingredient" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "price" numeric(8,2) NOT NULL, "unit" character varying NOT NULL, "userId" integer, CONSTRAINT "PK_6f1e945604a0b59f56a57570e98" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
